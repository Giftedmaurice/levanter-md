...
╭────────────────
│ Bot Prefix : ${PREFIX}
│ Bot User : ${message.pushName}
│ Live Time : ${date.toLocaleTimeString()}
│ Today is : ${date.toLocaleString('en', { weekday: 'long' })}
│ Today's Date : ${date.toLocaleDateString('hi')}
│ Bot Version : ${VERSION}
